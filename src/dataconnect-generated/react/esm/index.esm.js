import { addNewTaskRef, listTasksForFarmRef, updateTaskStatusRef, listAllCropsRef, connectorConfig } from '../../esm/index.esm.js';
import { validateArgs, CallerSdkTypeEnum } from 'firebase/data-connect';
import { useDataConnectQuery, useDataConnectMutation, validateReactArgs } from '@tanstack-query-firebase/react/data-connect';

export function useAddNewTask(dcOrOptions, options) {
...
export function useListAllCrops(dcOrOptions, options) {
