...
/**
 * @fileOverview An AI-powered alert system for SwiftBiz.
 *
...
const alertPrompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant designed to identify critical issues for SwiftBiz users and generate concise alerts.
